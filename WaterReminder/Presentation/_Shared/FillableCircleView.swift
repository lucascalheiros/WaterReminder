...
class FillableCircleView: UIView {
    ...
    private func setupView() {
        ...
        let hConstraint: NSLayoutConstraint = mFilledView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: percentage)
    ...
    private func updateFilledPercentage() {
        ...
        let newHeightConstraint = mFilledView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: percentage)
