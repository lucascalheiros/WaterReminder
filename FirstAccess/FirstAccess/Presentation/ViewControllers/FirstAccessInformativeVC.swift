...
class FirstAccessInformativeVC: BaseChildPageController {
    ...
    static func newInstance(firstAccessInformationViewModel: FirstAccessInformationSharedViewModel) -> FirstAccessInformativeVC {
        FirstAccessInformativeVC(firstAccessInformationViewModel: firstAccessInformationViewModel)
    }
